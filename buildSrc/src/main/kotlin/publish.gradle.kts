    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/volodroid/composepermissiondialog/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/volodroid/composepermissiondialog.git")
                    developerConnection.set("scm:git:ssh://github.com/volodroid/composepermissiondialog.git")
                    url.set("https://github.com/volodroid/composepermissiondialog/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/volodroid/composepermissiondialog/issues")
                }
            }
        }
    }
